...
| ✔ CLOSED 2026-07-31 | RT9080 dropout margin is thin during the ~465mA EPD refresh peak if low-battery shutdown is ever lowered to 3.4–3.5V; keep ≥3.6V or measure refresh-peak VOUT | Deep Review |
| | → Measured (BOD probe, 2026-07-30, notes.md): ~300mV droop at the peak. The threshold was then deliberately set **below** 3.6V — 3550/3500 mV (`1e1048e`). Do not restore the ≥3.6V guidance from this row. | |
