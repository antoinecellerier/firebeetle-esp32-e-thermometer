...
| R3 BMP58x @0x47, LP core | LP_I2C fixed to GPIO6/7 (C6 datasheet) = U1.15/16 = firmware pins (`include/app_common.h`, `ulp/lp_core_main.c`); BMP581 symbol == Bosch Table 28, BMP585 == Table 26 (pinouts differ, checked separately); CSB→VDDIO = I2C, SDO→VDDIO = 0x47 per both datasheets; INT-floating sanctioned by Bosch §6.2 |
