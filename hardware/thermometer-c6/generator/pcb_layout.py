...
TRACKS = [
    ("GND", "F.Cu", 0.15, [(8.85, 24.475), (8.875, 24.475), (8.9, 24.45), (8.95, 24.45), (8.975, 24.425), (9.1, 24.425), (9.125, 24.4), (9.2, 24.4), (9.225, 24.375), (9.65, 24.375), (9.9, 24.625), (9.9, 24.7), (9.925, 24.725), (10.125, 26.125)]),
    ...
    ("GND", "F.Cu", 0.15, [(40.025, 14.525), (38.125, 14.525), (36.3, 12.7), (36.25, 12.7), (36.175, 12.625), (36.15, 12.625), (36.125, 12.6), (36.0, 12.6), (35.975, 12.575), (34.85, 12.575), (34.275, 12.0), (32.675, 11.125)]),
    ("GND", "F.Cu", 0.15, [(22.175, 12.45), (22.475, 11.775), (22.5, 11.75), (22.5, 11.55), (22.575, 11.475), (22.575, 11.45), (22.6, 11.425), (22.6, 11.375), (22.625, 11.35), (22.625, 7.075), (21.55, 6.0)]),
    ...
    ("GND", "F.Cu", 0.15, [(16.0, 20.2), (16.9, 20.2), (17.95, 21.25), (17.975, 21.25), (18.0, 21.275), (18.025, 21.275), (18.05, 21.3), (18.15, 21.3), (18.175, 21.325), (19.35, 22.05)]),
    ("GND", "F.Cu", 0.15, [(8.425, 21.625), (9.1, 21.925), (9.125, 21.95), (9.8, 22.125)]),
    ...
    ("GND", "F.Cu", 0.15, [(12.175, 25.775), (12.475, 25.475), (12.525, 25.475), (12.875, 25.125), (12.9, 25.125), (12.925, 25.1), (12.975, 25.1), (13.0, 25.075), (13.675, 25.075), (13.8, 25.2), (13.8, 25.225), (13.85, 25.275), (13.85, 25.3), (13.875, 25.325), (13.875, 25.35), (13.9, 25.375), (14.425, 26.4)]),
    ("GND", "F.Cu", 0.15, [(33.675, 19.9), (33.27, 19.19)]),
    ("GND", "F.Cu", 0.15, [(29.375, 13.775), (29.375, 11.25), (29.425, 11.2)]),
    ("GND", "F.Cu", 0.15, [(16.017, 5.5), (16.3, 5.783)]),
    ("GND", "F.Cu", 0.15, [(23.652, 11.34), (22.675, 11.125)]),
    ("GND", "F.Cu", 0.15, [(42.35, 14.525), (42.634, 14.241), (45.241, 14.241), (45.55, 14.55), (46.225, 14.55)]),
    ("GND", "F.Cu", 0.15, [(9.875, 24.25), (9.75, 24.375)]),
    ("GND", "F.Cu", 0.15, [(0.8, 21.9), (1.84, 21.9), (1.84, 22.4)]),
    ...
    ("GND", "F.Cu", 0.2, [(13.02, 22.49), (11.37, 21.745)]),
    ("GND", "F.Cu", 0.2, [(14.7, 7.0), (16.3, 7.0), (16.75, 8.0)]),
    ("GND", "F.Cu", 0.2, [(27.72, 6.05), (29.59, 5.79), (30.61, 4.77)]),
    ("GND", "F.Cu", 0.2, [(4.4, 22.9), (4.35, 22.95), (4.25, 22.85)]),
    ("GND", "F.Cu", 0.2, [(37.062, 2.25), (38.3, 2.825), (38.3, 4.63), (38.8, 5.13)]),
    ("GND", "F.Cu", 0.2, [(15.8, 19.85), (15.8, 20.851), (15.23, 21.421), (15.23, 21.5)]),
    ("GND", "F.Cu", 0.2, [(4.35, 22.95), (3.412, 22.95), (3.362, 22.9)]),
    ("GND", "F.Cu", 0.2, [(32.7, 16.81), (33.353, 17.463), (34.403, 17.463), (34.765, 17.825), (36.875, 17.825), (37.95, 16.75), (39.35, 18.15), (39.35, 19.15), (38.85, 19.65), (35.09, 19.19), (33.27, 19.19)]),
    ("GND", "F.Cu", 0.2, [(30.5, 33.4), (30.87, 32.4)]),
    ("GND", "F.Cu", 0.2, [(46.225, 19.05), (44.55, 19.05), (44.5, 19.0), (41.2, 19.0)]),
    ("GND", "F.Cu", 0.2, [(5.12, 21.5), (6.72, 19.9), (6.85, 19.9)]),
    ("GND", "F.Cu", 0.2, [(11.0, 9.8), (13.4, 9.8), (13.5, 9.7)]),
    ("GND", "F.Cu", 0.2, [(20.15, 0.955), (19.995, 0.955)]),
    ("GND", "F.Cu", 0.25, [(20.15, 0.955), (19.235, 1.87), (19.08, 1.87), (19.08, 3.158), (16.988, 5.25), (16.283, 5.783), (16.3, 5.783), (14.158, 5.783), (14.1, 5.725), (13.3, 5.43)]),
    ("GND", "F.Cu", 0.25, [(19.08, 1.87), (17.06, 5.79), (16.307, 5.79), (16.3, 5.783)]),
    ("GND", "F.Cu", 0.25, [(14.6, 4.78), (14.58, 5.25), (14.575, 5.25), (14.1, 5.725)]),
    ("GND", "B.Cu", 0.15, [(15.225, 21.55), (15.375, 21.7), (16.85, 22.95), (16.9, 22.95), (16.925, 22.975), (16.95, 22.975), (16.975, 23.0), (18.3, 23.0), (18.35, 23.05), (18.375, 23.05), (18.425, 23.1), (18.45, 23.1), (18.5, 23.15), (18.525, 23.15), (18.55, 23.175), (18.625, 23.175), (18.65, 23.2), (19.1, 23.2), (19.25, 23.05), (19.25, 23.025), (19.3, 22.975), (19.3, 22.95), (19.35, 22.9), (19.35, 22.875), (19.375, 22.85), (19.375, 22.775), (19.4, 22.75), (20.25, 21.25)]),
    ...
    ("GND", "B.Cu", 0.15, [(14.1, 5.725), (13.2, 6.625), (13.2, 6.65), (13.175, 6.675), (13.175, 6.725), (13.15, 6.75), (13.15, 6.775), (13.125, 6.8), (13.125, 6.925), (13.1, 6.95), (13.1, 7.85), (14.95, 10.35)]),
    ...
    ("GND", "B.Cu", 0.15, [(36.025, 24.125), (36.175, 24.275), (37.275, 24.65)]),
    ("GND", "B.Cu", 0.15, [(22.425, 6.875), (23.341, 5.959), (27.629, 5.959), (27.72, 6.05)]),
    ("GND", "B.Cu", 0.15, [(11.475, 10.3), (15.575, 17.875)]),
    ("GND", "B.Cu", 0.15, [(14.425, 26.4), (14.45, 26.4)]),
    ("GND", "B.Cu", 0.15, [(42.35, 14.525), (40.025, 14.525)]),
    ("GND", "B.Cu", 0.15, [(11.275, 22.175), (11.325, 22.225)]),
    ("GND", "B.Cu", 0.2, [(40.635, 6.535), (38.8, 5.13)]),
    ("GND", "B.Cu", 0.2, [(19.08, 6.05), (21.5, 6.05), (21.55, 6.0)]),
    ("GND", "B.Cu", 0.2, [(11.375, 22.275), (11.37, 22.27), (11.37, 21.745), (9.57, 21.895), (9.85, 22.175), (11.275, 22.175), (11.7, 22.6), (11.7, 23.249), (10.699, 24.25), (9.875, 24.25), (12.611, 24.511), (14.889, 24.511), (15.025, 24.375)]),
    ("GND", "B.Cu", 0.2, [(26.9, 1.7), (26.6, 1.075), (26.65, 1.025), (27.495, 1.87), (31.0, 0.5)]),
    ("GND", "B.Cu", 0.2, [(44.5, 19.0), (44.5, 19.2), (44.2, 19.5)]),
    ("GND", "B.Cu", 0.2, [(2.7, 25.375), (2.7, 24.6)]),
]
VIAS = []
