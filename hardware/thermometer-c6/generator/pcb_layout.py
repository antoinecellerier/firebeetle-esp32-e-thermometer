...
TRACKS = [
    ("GND", "F.Cu", 0.15, [(19.95, 1.675), (19.65, 1.975), (19.65, 2.35), (19.625, 2.375), (19.625, 2.625), (17.1, 5.15), (17.05, 5.15), (16.975, 5.225), (16.875, 5.225), (16.85, 5.25), (14.58, 5.25), (14.575, 5.25), (14.1, 5.725)]),
    ...
    ("GND", "F.Cu", 0.15, [(6.925, 25.825), (7.225, 25.525), (7.6, 25.525), (7.625, 25.5), (8.0, 25.5), (8.675, 24.825), (8.675, 24.8), (8.7, 24.775), (8.7, 24.675), (8.725, 24.675), (8.725, 24.6), (8.85, 24.475), (8.875, 24.475), (8.9, 24.45), (8.95, 24.45), (8.975, 24.425), (9.1, 24.425), (9.125, 24.4), (9.2, 24.4), (9.225, 24.375), (9.65, 24.375), (9.9, 24.625), (9.9, 24.7), (9.925, 24.725), (9.925, 25.925), (10.125, 26.125)]),
    ...
    ("GND", "F.Cu", 0.15, [(45.625, 14.525), (42.35, 14.525)]),
    ...
    ("GND", "F.Cu", 0.15, [(33.675, 19.7), (33.675, 19.9)]),
    ("GND", "F.Cu", 0.15, [(14.58, 5.25), (14.6, 4.78)]),
    ("GND", "F.Cu", 0.15, [(32.375, 15.925), (32.0, 15.925)]),
    ("GND", "F.Cu", 0.15, [(34.825, 19.65), (33.725, 19.65)]),
    ...
    ("GND", "F.Cu", 0.15, [(44.0, 14.45), (44.0, 14.475)]),
    ...
    ("GND", "B.Cu", 0.15, [(38.05, 26.825), (38.175, 26.7), (38.775, 26.7), (43.125, 22.35), (43.125, 22.325), (43.15, 22.3), (43.15, 22.25), (43.175, 22.225), (43.175, 22.2), (43.2, 22.175), (43.2, 19.65), (43.85, 19.0), (43.85, 18.975), (43.9, 18.925), (43.9, 18.9), (43.95, 18.85), (43.95, 18.825), (43.975, 18.8), (43.975, 18.725), (44.0, 18.7), (44.0, 14.45)]),
    ...
    ("GND", "B.Cu", 0.15, [(41.75, 22.0), (41.9, 21.85), (41.9, 21.825), (42.25, 21.475), (42.275, 21.475), (42.3, 21.45), (42.35, 21.45), (42.375, 21.425), (42.4, 21.425), (42.425, 21.4), (43.15, 21.4)]),
    ("GND", "B.Cu", 0.15, [(21.55, 6.0), (20.0, 6.0), (19.5, 5.5)]),
    ("GND", "B.Cu", 0.15, [(16.05, 6.975), (16.05, 5.5)]),
    ("GND", "B.Cu", 0.15, [(14.425, 26.4), (14.45, 26.4)]),
    ("GND", "B.Cu", 0.15, [(32.0, 15.925), (31.525, 15.925), (29.375, 13.775)]),
