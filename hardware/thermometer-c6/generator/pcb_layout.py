...
TRACKS = [
    ('GND', 'F.Cu', 0.5, [(17.06, 5.79), (18.2, 4.65), (18.2, 1.0), (18.7, 0.6), (19.695, 0.6), (20.15, 0.955), (19.235, 1.87), (19.08, 1.87)]),
    ('GND', 'F.Cu', 0.5, [(8.425, 21.625), (8.503, 21.703), (9.543, 21.703), (9.8, 21.446), (9.8, 20.9)]),
    ('GND', 'F.Cu', 0.5, [(14.6, 4.775), (15.361, 4.775), (16.3, 5.714), (16.3, 5.783), (16.242, 5.725)]),
    ...
    ('GND', 'F.Cu', 0.5, [(16.3, 5.783), (16.283, 5.783), (16.3, 5.783)]),
    ('GND', 'F.Cu', 0.25, [(26.65, 0.955), (26.65, 1.403), (27.118, 1.87), (27.72, 1.87), (28.4, 1.87), (29.205, 1.065), (35.74, 1.065), (36.075, 1.4), (36.075, 1.651), (36.674, 2.25), (37.062, 2.25)]),
    ('GND', 'F.Cu', 0.25, [(10.125, 26.125), (9.955, 24.33), (9.875, 24.25), (9.25, 24.25), (8.11, 23.47)]),
    ('GND', 'F.Cu', 0.25, [(19.4, 22.7), (18.75, 22.05), (18.65, 22.05), (16.75, 20.15), (16.75, 19.9), (16.7, 19.85), (15.8, 19.85), (15.8, 20.5), (15.23, 21.5)]),
    ('GND', 'F.Cu', 0.25, [(22.01, 10.06), (22.665, 10.715), (22.665, 10.741), (23.264, 11.34), (23.08, 11.34), (21.98, 12.75), (21.98, 12.739), (21.356, 12.115), (20.535, 12.115), (20.315, 12.335), (20.315, 16.415), (19.58, 17.15), (16.7, 17.15), (15.8, 17.6), (15.8, 19.85)]),
    ...
    ('GND', 'F.Cu', 0.2, [(41.45, 19.05), (39.608, 19.05), (39.6, 19.042)]),
    ('GND', 'F.Cu', 0.45, [(17.06, 5.79), (14.165, 5.79), (14.1, 5.725), (14.075, 5.7), (13.7, 5.7), (13.43, 5.43), (13.3, 5.43)]),
    ('GND', 'F.Cu', 0.45, [(29.375, 13.775), (29.375, 11.255), (29.48, 11.15), (29.475, 11.15), (29.425, 11.2)]),
    ('GND', 'F.Cu', 0.45, [(29.48, 11.15), (29.48, 10.35), (30.8, 10.35)]),
    ...
    ('GND', 'B.Cu', 0.25, [(14.925, 24.475), (15.025, 24.375), (14.9, 24.5), (12.012, 24.5), (10.125, 24.5), (9.875, 24.25)]),
    ('GND', 'B.Cu', 0.25, [(27.72, 6.05), (23.25, 6.05), (22.425, 6.875)]),
    ('GND', 'B.Cu', 0.25, [(13.02, 22.49), (13.0, 22.51), (13.0, 24.4), (12.988, 24.412)]),
    ('GND', 'B.Cu', 0.2, [(11.0, 9.8), (11.0, 9.825), (11.475, 10.3)]),
]
VIAS = []
