...
TRACKS = [
    ...
    ('GND', 'F.Cu', 0.2, [(16.3, 17.35), (16.25, 17.4), (16.225, 17.4), (16.2, 17.425), (16.175, 17.425), (16.025, 17.575), (16.025, 17.6), (16.0, 17.625), (16.0, 20.15)]),
    ...
    ('GND', 'F.Cu', 0.5, [(20.15, 0.955), (19.995, 0.955)]),
    ('GND', 'F.Cu', 0.5, [(14.6, 4.78), (14.58, 5.25), (14.575, 5.25), (14.1, 5.725)]),
    ('GND', 'B.Cu', 0.15, [(22.425, 6.875), (23.341, 5.959), (27.629, 5.959), (27.72, 6.05)]),
    ('GND', 'B.Cu', 0.45, [(14.425, 26.4), (14.45, 26.4)]),
    ('GND', 'B.Cu', 0.5, [(40.635, 6.535), (38.8, 5.13)]),
    ('GND', 'B.Cu', 0.45, [(19.08, 6.05), (21.5, 6.05), (21.55, 6.0)]),
    ('GND', 'B.Cu', 0.5, [(44.5, 19.0), (44.5, 19.2), (44.2, 19.5)]),
    ('GND', 'B.Cu', 0.5, [(2.7, 25.375), (2.7, 24.6)]),
    ('GND', 'B.Cu', 0.15, [(36.025, 24.125), (36.175, 24.275)]),
    ('GND', 'B.Cu', 0.2, [(11.275, 22.175), (11.325, 22.225), (11.7, 22.6), (11.7, 23.249), (10.699, 24.25), (9.875, 24.25), (12.611, 24.511), (14.889, 24.511), (15.025, 24.375)]),
    ('GND', 'B.Cu', 0.2, [(11.375, 22.275), (11.37, 22.27)]),
    ('GND', 'B.Cu', 0.2, [(15.225, 21.55), (15.375, 21.7)]),
    ('GND', 'B.Cu', 0.2, [(10.125, 26.125), (10.9, 26.9), (11.8, 26.9)]),
    ('GND', 'B.Cu', 0.45, [(26.9, 1.7), (26.6, 1.075), (26.65, 1.025), (27.495, 1.87)]),
    ('GND', 'F.Cu', 0.2, [(37.062, 2.25), (36.25, 2.25), (36.0, 2.0), (36.0, 1.405), (35.685, 1.09), (29.215, 1.09), (28.435, 1.87), (27.72, 1.87)]),
    ('GND', 'F.Cu', 0.2, [(42.35, 14.525), (42.634, 14.241), (45.241, 14.241), (45.55, 14.55), (46.225, 14.55)]),
    ('GND', 'F.Cu', 0.2, [(15.23, 21.5), (15.23, 21.421), (15.8, 20.851), (15.8, 19.85), (16.7, 19.85), (16.75, 19.9), (16.75, 20.016), (18.734, 22.0), (19.3, 22.0), (19.35, 22.05)]),
    ('GND', 'F.Cu', 0.2, [(11.91, 26.0), (12.84, 25.07), (13.67, 25.07), (14.0, 25.4), (14.3, 25.4), (14.53, 25.4), (14.6, 25.33), (14.6, 25.329), (14.859, 25.07), (14.86, 25.07), (15.025, 24.905), (15.025, 24.375)]),
    ('GND', 'F.Cu', 0.2, [(37.95, 13.15), (36.685, 13.15), (35.935, 12.4), (34.62, 12.4), (33.27, 11.05)]),
    ('GND', 'F.Cu', 0.2, [(8.11, 23.47), (8.89, 24.25), (9.875, 24.25), (10.0, 24.375), (10.0, 26.0), (10.125, 26.125)]),
    ('GND', 'F.Cu', 0.2, [(14.425, 26.4), (14.3, 26.275), (14.3, 25.4)]),
    ('GND', 'F.Cu', 0.2, [(8.362, 28.35), (9.066, 28.35), (9.675, 28.959), (9.675, 30.805), (10.09, 31.22)]),
    ('GND', 'F.Cu', 0.25, [(20.15, 0.955), (19.235, 1.87), (19.08, 1.87), (19.08, 3.158)]),
    ('GND', 'F.Cu', 0.25, [(32.7, 16.81), (33.655, 17.765), (34.239, 17.765), (34.474, 18.0), (36.7, 18.0), (37.95, 16.75), (39.375, 18.175), (39.375, 19.109), (38.834, 19.65), (35.55, 19.65), (33.73, 19.65), (33.27, 19.19)]),
    ('GND', 'F.Cu', 0.25, [(37.062, 2.25), (38.3, 2.825), (38.3, 4.63), (38.8, 5.13)]),
    ('GND', 'F.Cu', 0.25, [(16.283, 5.783), (16.3, 5.783), (14.158, 5.783), (14.1, 5.725)]),
    ('GND', 'F.Cu', 0.25, [(27.72, 6.05), (29.59, 5.79), (30.61, 4.77)]),
    ('GND', 'F.Cu', 0.4, [(17.06, 5.79), (14.165, 5.79), (14.1, 5.725), (13.595, 5.725), (13.3, 5.43)]),
    ('GND', 'F.Cu', 0.4, [(14.1, 5.725), (16.242, 5.725), (16.3, 5.783)]),
    ('GND', 'F.Cu', 0.5, [(14.6, 4.775), (15.292, 4.775), (15.361, 4.775), (15.961, 5.375), (17.039, 5.375), (17.425, 4.989), (17.425, 4.388), (18.375, 3.438), (18.375, 1.87), (19.08, 1.87)]),
]
VIAS = []
