...
REF_ROTATION_OVERRIDES = {  # local-library footprints; override beats pattern
    ...
    "J3": 0,   # local:USB_C_Receptacle_HRO_TYPE-C-31-M-12: RESPUN 2026-07-19 mouth-north (placement rotation 0 -> 180, out/j3-proof/), then again 2026-07-20 (datum move +1.415mm south, out/j3-datum/, plus a local footprint fork with a corrected land, out/j3-land/ -- rotation unchanged at 180). The FAB_ROTATIONS +180 delta was preview-verified for the old rot-0 placement; with placement now 180 the required CPL delta is unverified -- re-walk the JLC preview before ordering.  confidence: low  verified:
